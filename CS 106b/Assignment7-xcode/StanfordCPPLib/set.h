 ...
 * Usage: stream << set
 * --------------------
 * Displays the elements of a set surrounded by curly braces and
 * separated by commas.  The value type must implement the << operator.
 */
 ...
 * Usage: stream >> set
 * --------------------
 * Reads a set from the specified stream.  This operator uses a template
 * so that it works with any base type that supports the >> operator.
 */
