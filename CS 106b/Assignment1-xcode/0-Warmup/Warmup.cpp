...
int hashCode(string str); //changed "int key" to "string str" because that is the proper input for hashCode
...
int hashCode(string str) {
   ...
   for (int i = 0; i < nchars; i++) { //Added int before i to declare i as an integer
